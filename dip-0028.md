...
Evolution Nodes (evonodes) into the Dash ecosystem. Evolution Nodes are a new
...
storage which are deployed on the Evolution Nodes.

Implementing Evolution Nodes for Dash Platform brings about a number of important
...
“Evolution Nodes” solution described in this DIP.
...
An Evolution Node (evonodes) is like a regular masternode (MN) but with three key
differences:
...
The Evolution Nodes solution addresses all of the concerns outlined in the
...
Evolution Nodes are implemented in Dash Core v19.0. The initial implementation is
