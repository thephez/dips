...
**Note:** The multiple signing attempt process described in the [previous section](#signing-attempts) was not included in
the initial ChainLocks implementation. Currently the signing process goes immediately to this
finalization step.
